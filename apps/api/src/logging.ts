...
export type ApiLogEvent =
  ...
  | "users.bootstrap.id_token_email_unverified"
  | "users.bootstrap.id_token_invalid"
  | "users.bootstrap.id_token_missing"
  | "users.bootstrap.id_token_subject_mismatch"
  | "users.bootstrap.id_token_verifier_missing"
  | "admin.forbidden"
  | "admin.audit.loaded"
  ...
  | "seasons.not_found"
  | "seasons.rename.forbidden"
  | "seasons.renamed"
  | "seasons.start.forbidden"
  | "seasons.started"
  | "points.actor_not_found"
  | "points.active_season_missing"
  | "points.actor_house_unassigned"
  | "points.self_award_rejected"
  | "points.target_user_unassigned"
  | "points.cross_organization_target"
  | "points.adjusted"
  | "points.deduct.actor_not_found"
  | "points.deduct.actor_house_required"
  | "points.deduct.target_user_not_found"
