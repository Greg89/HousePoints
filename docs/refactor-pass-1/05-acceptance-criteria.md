...
- [-] API inputs and web-consumed outputs are validated with shared schemas. Dashboard reads, admin context, current-user mapping, point-award responses, and invite creation are covered; remaining mutation responses are not.
