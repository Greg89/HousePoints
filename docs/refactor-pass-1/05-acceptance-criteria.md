...
- [-] API inputs and web-consumed outputs are validated with shared schemas. Dashboard reads, admin context, current-user mapping, and point-award responses are covered; remaining mutation responses are not.
