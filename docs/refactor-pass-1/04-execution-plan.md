...
5. [-] Split routes into domain modules without redesigning every query. Health, seasons, admin, and org route registration have been extracted to establish the route module pattern; additional domain routes remain in `app.ts`.
