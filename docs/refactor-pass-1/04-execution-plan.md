...
5. [-] Split routes into domain modules without redesigning every query. Health and seasons route registration have been extracted to establish the route module pattern; additional domain routes remain in `app.ts`.
