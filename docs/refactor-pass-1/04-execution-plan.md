...
4. [-] Convert expected action failures to typed results. Dashboard and admin-context reads now use typed response errors; mutation actions still throw generic errors.
...
3. [-] Export response and error schemas from contracts. Current-user, dashboard, and admin-context response schemas exist; remaining operations still need schemas.
4. [-] Parse all API responses in the web client. Current-user, dashboard, and admin-context reads are parsed; mutation responses remain.
