...
5. [-] Split routes into domain modules without redesigning every query. Health route registration has been extracted to establish the route module pattern; domain routes remain in `app.ts`.
