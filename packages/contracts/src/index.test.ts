...
const webConsumedApiEndpoints = [
  ...
  "/platform/account-deletions/complete",
  "/platform/organizations/detail",
  "/platform/organizations/status",
  "/platform/organizations/revoke-invites",
  "/platform/organizations/revoke-invite",
  "/platform/users/search",
  "/platform/users/revoke-devices",
  "/platform/support-cases/list",
  ...
  "/platform/moderation/reports/resolve",
  "/platform/settings",
  "/points/deduct",
  "/points/delete",
  "/seasons/context",
